  ...
  return (
    <section className="about-section">
      ...
      <div className="about-content">
       <p>
  Hello, I'm <span className="highlight">Arshiya</span>. I have successfully completed my **Master of Computer Applications (MCA) from Parul University**, following my Bachelor of Computer Applications (BCA) from BKMNU University (2021-2024).
</p>
        <p>
